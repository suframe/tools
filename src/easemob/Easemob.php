...
use suframe\tools\easemob\app\EasemobError;
use suframe\tools\easemob\app\EasemobGroups;
use suframe\tools\easemob\app\EasemobMessages;
use suframe\tools\easemob\app\EasemobRooms;
use suframe\tools\easemob\app\Http;
...
class Easemob
{
    ...
    public function getToken()
    {
        if (Cache::has(self::CACHE_NAME)) {
            ...
            Cache::set(self::CACHE_NAME, $return['access_token'], (int)($return['expires_in'] / 60));
